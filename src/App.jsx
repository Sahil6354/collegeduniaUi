        ...
        <div className="p-5 h-screen bg-gray-100">
          <div className="overflow-auto rounded-lg shadow hidden md:block">
            <table className="w-full">
              <thead className="bg-[#14b8a6] border-b-2 border-black-300">
                <tr>
              ...
              <tbody className="divide-y bg-gray-400">
                    ...
                    >
                      <>
                        <td className="p-3 text-sm text-gray-700 whitespace-nowrap w-1/12">
                          <a
                            href="#"
                            className="font-bold text-back-200 hover:underline"
                          >
                            #{item.ranking}
                          </a>
                        </td>
                        <td className="p-3 text-sm text-gray-700 whitespace-nowrap w-4/12">
                          ...
                          <div className="flex justify-between">
                            <button className="m-4 text-orange-600">
                              <i class="fa-solid fa-arrow-right"></i> Apply Now
                            </button>
                            <button className="m-4 text-[#22c55e]">
                              {" "}
                        ...
                        <td className="p-3 text-sm text-gray-700 whitespace-nowrap">
                          <div>
                            <a href="">{item.userReviewScore}/10</a>
                            ...
                            <a
                              href=""
                              className="text-green-600 bg-[#fef3c7] rounded-2xl pl-2 pr-2"
                            >
